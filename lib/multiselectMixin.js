...
exports.default = {
	...
	methods: {
		...
		updatePos: function updatePos() {
			if (this.isOpen) {
				...
				var _$el$getBoundingClien2 = this.$el.getBoundingClientRect(),
				    ...
				    bottom = _$el$getBoundingClien2.bottom;
		...
		getValue: function getValue() {
			return this.multiple ? (0, _utils2.default)(this.internalValue) : this.internalValue.length === 0 ? null : (0, _utils2.default)(Object.prototype.hasOwnProperty.call(this.internalValue[0], this.trackBy) ? this.internalValue[0][this.trackBy] : this.internalValue[0]);
		},
		getInternalValue: function getInternalValue(value) {
			return value === null || value === undefined ? [] : this.multiple ? (0, _utils2.default)(value) : (0, _utils2.default)(this.transformLocalValue(value) ? [this.transformLocalValue(value)] : []);
		},
		transformLocalValue: function transformLocalValue(value) {
			var _ref2;

			if ((0, _isArray2.default)(this.options)) {
				for (var i = 0; i < this.options.length; i++) {
					var item = this.options[i];
					if (item === value || (0, _isObject2.default)(value) && (0, _isObject2.default)(item) && value[this.trackBy] === item[this.trackBy] || (0, _isObject2.default)(item) && value === item[this.trackBy]) {
						return item;
					}
				}
			}
			return _ref2 = {}, _defineProperty(_ref2, this.trackBy, ''), _defineProperty(_ref2, this.label, ''), _ref2;
		},
		...
		removeAll: function removeAll() {
			...
			var vals = (0, _utils2.default)(this.internalValue);
			this.internalValue = [];

			vals.forEach(function (v) {
				_this3.$emit('remove', (0, _utils2.default)(v), _this3.id);
			});
